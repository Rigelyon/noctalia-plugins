...
- Displays the active monitor profile in the bar (optional)
- Switch profiles from the panel with a single click
- Tooltip on hover with the active profile name
- Configurable icon color and refresh interval
